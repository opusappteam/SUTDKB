...
/* 	    $query1_update_custom_fields = "insert into
                 FROM `glpi_tickettasks`
                 WHERE `tickets_id` = '".$this->fields['id']."'"; */
	
				//echo(date_format($_POST["datetimepicker"],"Y/m/d H:i:s"));
				
				$date=date_create($_POST["datetimepicker"]);
              // echo date_format($date,"Y/m/d H:i:s");
				 
				 if( ($_POST["status"]==4)   ||  ($_POST["requesttypes_id"]==2)     )
				 {
...
/*             echo $tt->getBeginHiddenFieldValue('due_date');
	 ...
	 /* else { // New Ticket
      ...
      echo $tt->getEndHiddenFieldText('urgency')."";
	    ...
	    echo "</th><td><input type='text'  id='datetimepicker' name='datetimepicker'  value='".$EmailDate."'  readonly />   <a href=javascript:NewCal('datetimepicker','ddmmmyyyy',true,24)><img src='../Customfields/css/cal.gif' width='16' height='16' border='0' alt='Pick a date'></a>";
	   echo "</td>";
	   echo "</th> ";

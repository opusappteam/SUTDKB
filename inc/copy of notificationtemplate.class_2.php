   ...
   **/
   function getTemplateByLanguage(NotificationTarget $target, $user_infos=array(), $event,
      ...
      if (!isset($this->templates_by_languages[$tid])) {
        ...
        /**mod by AKK 22 april 2015**/
		//$footer_string = sprintf(__('Automatically generated by GLPI %s'), GLPI_VERSION);
		 $footer_string = sprintf(__('Automatically generated by SUTD GLPI-based IT Service Management '), GLPI_VERSION);
            /**mod by AKK 22 april 2015**/
 ...
 /**mod by AKK 22 april 2015**/
           /*  $lang['content_text']
                  ...
                  = (!empty($add_header)?$add_header."\n\n":'').
                    Html::clean(self::process($template_datas['content_text'],
                                $data)."\n\n-- \n".$this->signature.
                                      "\n".sprintf(__('Automatically generated by SUTD GLPI-based IT Service Management'),
                                                   GLPI_VERSION)).
                    "\n\n".$add_footer;

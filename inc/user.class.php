...
//         echo "<img src='".self::getURLForPicture($this->fields["picture"])."' class='user_picture'/>";
   ...
   //AKK :: on 10 april 2015 For LDAP Colour Changes
	 if($extauth)
			 $LDAPSTYLE='style="background-color: #28CF65;font-weight: bold"';
    
	
      echo "<tr><td><div $LDAPSTYLE>" . __('Surname') . "</div></td><td>";
      Html::autocompletionTextField($this,"realname");
      echo "</td></tr>";
    //AKK :: on 10 april 2015 For LDAP Colour Changes
      echo "<tr ><td><div $LDAPSTYLE>" . __('First name') . "</div></td><td>";
      ...
      echo "</td>";
      echo "<td> <div $LDAPSTYLE>" . _n('Email','Emails',2);
      ...
      echo "<tr class='tab_bg_1'>";
//AKK :: on 10 april 2015 For LDAP Colour Changes     
	 echo "<td><div $LDAPSTYLE>" .  __('Phone') . "</div></td><td>";
      ...
      if (!empty($ID)) {
         if (Session::haveRight(self::$rightname, self::READAUTHENT)) {
			...
			//Mod by AKK for LDAP Color Change on 09 April 2015
			/* if($extauth)
			 $LDAPSTYLE='style="background-color: #28CF65;font-weight: bold"'; */
			echo "<td>" . __('Authentication') . "</td><td><div  $LDAPSTYLE> ";
            ...
            echo "</div></td>"; //Mod by AKK for LDAP Color Change on 09 April 2015
         } else {
      ...
      echo "</td></tr>";
     //AKK :: on 10 april 2015 For LDAP Colour Changes
      echo "<tr><td><div $LDAPSTYLE>" . __('Administrative number') . "</div></td><td>";
      Html::autocompletionTextField($this, "registration_number");
      echo "</td></tr>";
       //AKK :: on 10 april 2015 For LDAP Colour Changes
      echo "<tr ><td><div $LDAPSTYLE>" . _x('person','Title') . "&nbsp;:</div></td><td>";

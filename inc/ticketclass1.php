	 ...
	 /* else { // New Ticket
      ...
      if (!$ID
		...
		// echo ("<a target=_blank href='../Customfields/index.php?TicketID=$_GET[id]'  > Priority Reasons </a>");  ?>
		 ...
		 <a href="../Customfields/index.php?TicketID=<?php echo($_GET[id]) ?> " onclick="window.open(this.href, 'mywin',
'left=20,top=20,width=500,height=350,toolbar=1,resizable=0'); return false;" >Additional fields</a>
